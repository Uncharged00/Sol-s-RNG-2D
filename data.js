...
const GEAR_RECIPES=[
  ...
  {gear:"Genesis Drive",desc:"+1200% Luck +80% Speed",hand:"R",
  ...
  // ── Mid-tier missing gears ──
  {gear:"Desire Glove",desc:"+50% Luck",hand:"R",
   ingredients:[{name:"Gear Basing",qty:2},{name:"Sidereum",qty:1},{name:"Precious",qty:3},{name:"Divinus",qty:5}]},
  ...
  {gear:"Frozen Gauntlet",desc:"+150% Luck, -25% Speed",hand:"R",
   ingredients:[{name:"Gear Basing",qty:5},{name:"Permafrost",qty:3},{name:"Glacier",qty:5},{name:"Aquamarine",qty:15},{name:"Sidereum",qty:5}]},
  {gear:"Exoflex Device",desc:"+340% Luck +35% Speed",hand:"R",
   ingredients:[{name:"Gear Basing",qty:8},{name:"Exotic",qty:3},{name:"Galactic Device",qty:1},{name:"Magnetic",qty:100},{name:"Sidereum",qty:20},{name:"Precious",qty:80}]},
  {gear:"Hologrammer",desc:"+400% Luck +40% Speed",hand:"R",
   ingredients:[{name:"Gear Basing",qty:10},{name:"Virtual",qty:5},{name:"Exoflex Device",qty:1},{name:"Powered",qty:30},{name:"Comet",qty:5}]},
  {gear:"Ragnaröker",desc:"+455% Luck +40% Speed",hand:"R",
   ingredients:[{name:"Gear Basing",qty:10},{name:"Hades",qty:1},{name:"Volcanic Device",qty:1},{name:"Diaboli",qty:200},{name:"Rage",qty:2000},{name:"Sidereum",qty:50}]},
  {gear:"Starshaper",desc:"+600% Luck +50% Speed",hand:"R",
   ingredients:[{name:"Gear Basing",qty:15},{name:"Starscorge: Radiant",qty:1},{name:"Hologrammer",qty:1},{name:"Comet",qty:20},{name:"Powered",qty:50}]},
  {gear:"Neuralyzer",desc:"+750% Luck +60% Speed",hand:"R",
   ingredients:[{name:"Gear Basing",qty:20},{name:"Starshaper",qty:1},{name:"Ragnaröker",qty:1},{name:"Virtual",qty:10},{name:"Comet",qty:10},{name:"Powered",qty:80}]},
  // ── Tier 9 additions ──
